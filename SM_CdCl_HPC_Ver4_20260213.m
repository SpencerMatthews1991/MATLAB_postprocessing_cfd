...
aoa16 = readmatrix('./AoA16/lift_coefficient-rfile_121.out', 'FileType', 'text', 'NumHeaderLines', 3);
...
for i = 1:numCases
    ...
    try
        % Load data files
        dragf = readmatrix(fullfile(currentDir, 'drag-rfile_121.out'), ...
            'FileType', 'text', 'NumHeaderLines', 3);
        liftf = readmatrix(fullfile(currentDir, 'lift-rfile_121.out'), ...
            'FileType', 'text', 'NumHeaderLines', 3);
        skinf = readmatrix(fullfile(currentDir, 'skin_friction-rfile_121.out'), ...
            'FileType', 'text', 'NumHeaderLines', 3);
        clcdf = readmatrix(fullfile(currentDir, 'cl-cd-rfile_121.out'), ...
            'FileType', 'text', 'NumHeaderLines', 3);
        clf = readmatrix(fullfile(currentDir, 'lift_coefficient-rfile_121.out'), ...
            'FileType', 'text', 'NumHeaderLines', 3);
        cdf = readmatrix(fullfile(currentDir, 'drag_coefficient-rfile_121.out'), ...
            'FileType', 'text', 'NumHeaderLines', 3);
...
% Cl vs AoA
subplot(2,2,1)
plot(aoaValues, Cl_calc, '-o', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Cl_solver, '--s', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Ku_cl(:,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Il_cl(:,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
xlabel('Angle of Attack (degrees)')
ylabel('Lift Coefficient (C_l)')
title('Lift Coefficient vs AoA')
legend('Calculated', 'CFD Solver', 'Target: Kurtulus', 'Target: Ilio', 'Location', 'best')
grid on

% Cd vs AoA
subplot(2,2,2)
plot(aoaValues, Cd_calc, '-o', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Cd_solver, '--s', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Ku_cd(:,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Il_cd(:,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
xlabel('Angle of Attack (degrees)')
ylabel('Drag Coefficient (C_d)')
...
% Cl/Cd vs AoA
subplot(2,2,3)
plot(aoaValues, ClCd_calc, '-o', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, ClCd_solver, '--s', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Ku_clcd(:,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Il_clcd(:,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
xlabel('Angle of Attack (degrees)')
ylabel('Aerodynamic Efficiency (C_l/C_d)')
...
% Cl vs Cd 
subplot(2,2,4)
plot(Cd_calc, Cl_calc, '-o', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(Cd_solver, Cl_solver, '--s', 'LineWidth', 2, 'MarkerSize', 8)
...
saveas(gcf,'YYYYMMDD_SM_dataprocess_out.png','png') %Rename me!
...
resultsTable = table(aoaValues', Cl_calc, Cd_calc, ClCd_calc, ...
    ...
    'Cl_solver', 'Cd_solver', 'ClCd_solver'});
writetable(resultsTable, 'YYYYMMDD_AoA_sweep_results.csv'); %Rename me!
...
plot(Ku_cl(:,1),Ku_cl(:,2) , 'r-s', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Cl_calc, 'c-v', 'LineWidth', 2, 'MarkerSize', 8)
hold on
xlabel('Angle of Attack (degrees)')
ylabel('Lift Coefficient (C_l)')
title('Lift Coefficient (C_l) vs AoA')
legend('Matthews', 'Ilio', 'Khalid', 'Liu', 'Kurtulus', 'Location', 'best')
grid on
...
plot(Ku_cd(:,1),Ku_cd(:,2) , 'r-s', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Cd_calc, 'c-v', 'LineWidth', 2, 'MarkerSize', 8)
hold on
xlabel('Angle of Attack (degrees)')
ylabel('Drag Coefficient (C_d)')
title('Drag Coefficient (C_d) vs AoA')
legend('Matthews', 'Ilio', 'Kurtulus', 'Location', 'best')
grid on
...
saveas(gcf,'YYYYMMDD_SM_dataprocess_comparison.png','png') %Rename me!
...
Cl_percentDiff = ((Cl_calc' - Il_cl_interp) ./ Il_cl_interp) * 100;
Cd_percentDiff = ((Cd_calc' - Il_cd_interp) ./ Il_cd_interp) * 100;
