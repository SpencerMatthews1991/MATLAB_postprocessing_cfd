...
% 
% Special Version (This version): A derivative of version 3 design for 
% troubleshooting and singal analysis of various metrics at a single AoA 
% test case for transient flow of the NACA0012.
...
% Directory paths and AoA array that can be turned on or off as needed
...
aoa16 = readmatrix('./AoA16/lift_coefficient-rfile.out', 'FileType', 'text', 'NumHeaderLines', 3);
...
saveas(gcf,'Ilio2018_reconstruction.png','png') %Rename me! (If you wnat)
...
hold on
plot(aoaValues, Ku_cl(17,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Il_cl(13,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
xlabel('Angle of Attack (degrees)')
ylabel('Lift Coefficient (C_l)')
...
hold on
plot(aoaValues, Ku_cd(17,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Il_cd(13,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
xlabel('Angle of Attack (degrees)')
ylabel('Drag Coefficient (C_d)')
...
hold on
plot(aoaValues, Ku_clcd(17,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
hold on
plot(aoaValues, Il_clcd(13,2), '-x', 'LineWidth', 2, 'MarkerSize', 8)
xlabel('Angle of Attack (degrees)')
ylabel('Aerodynamic Efficiency (C_l/C_d)')
...
legend('Ilio', 'Kurtulus', 'Location', 'Matthews', 'best')
grid on
...
ClCd_percentDiff = ((ClCd_solver' - Il_clcd_interp) ./ Il_clcd_interp) * 100;
