...
% troubleshooting and singal analysis of various metrics at AoA16 test case
% for transient flow of the NACA0012.
...
saveas(gcf,'20260213_SM_dataprocess_out.png','png') %Rename me!
...
resultsTable = table(aoaValues', Cl_calc, Cd_calc, ClCd_calc, ...
    ...
    'Cl_solver', 'Cd_solver', 'ClCd_solver'});
writetable(resultsTable, '20260213_AoA_sweep_results.csv'); %Rename me!
...
saveas(gcf,'20260213_SM_dataprocess_comparison.png','png') %Rename me!
