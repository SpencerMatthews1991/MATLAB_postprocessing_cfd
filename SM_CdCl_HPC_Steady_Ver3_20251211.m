...
% 
% Version 3 steady: Adjusted for low AoA steady state simulation analysis
...
aoaDirs = {'AoA0','AoA1', 'AoA2','AoA3', 'AoA4','AoA5'};
aoaValues = [0,1,2,3,4,5];  % Corresponding AoA values in degrees
